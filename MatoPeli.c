...
void countDown(){
    setCursorXY(SNAKE_START_X-4,SNAKE_START_Y-4);
    printf("%s","Paikoillanne");
    Sleep(500);
    setCursorXY(SNAKE_START_X-4,SNAKE_START_Y-4);
    printf("%s","  Valmiit   ");
    Sleep(500);
...
bool yesNoInput(){
    while (1) {
        ...
        if (key_code == 'k' || key_code == 'K') return true; 
        if (key_code == 'e' || key_code == 'E') return false; 
    }
}
...
void drawPlayField(){
    ...
    printf("#################");
    setCursorXY(x,y+1);
    printf("|Kayta WASD tai |");
    setCursorXY(x,y+2);
    printf("|nuolinappaimia |");
    setCursorXY(x,y+3);
    printf("|ohjaukseen     |");
    setCursorXY(x,y+4);
    printf("| P =  paussi   |");
